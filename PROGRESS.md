...
3. **Hardware database** — fasteners, glues, finishes with prices. Pairs with Lumber Prices for true total cost.
4. **Fill out remaining ~40 species** with tree+region data (currently 18/58 covered).
